  ...
  return (
    <div className="overflow-hidden flex ">
      <div className="flex w-full flex-col h-screen justify-between">
        <div className="flex mt-[100px] ">
          <h1 className=" text-8xl text-pink-300 ">
            Hey There,
            <br />
            <span className="text-white">I'm Harsh!</span>
          </h1>
        </div>
        <div className="text-2xl flex flex-col gap-2">
          <h2 className="text-4xl">Top Rated Designers</h2>
      ...
      <div className=" flex w-full items-end justify-between h-screen flex-col ">
        <div className="flex gap-4 bg-blue-900 flex-col h-100% w-[60px] justify-center rounded-b-md items-center">
          ...
          <div className="bg-red-500 w-max h-max mt-7 py-1.5 px-1.5 rounded-br-lg rotate-90">
            Follow Me!
          </div>
        ...
        <Speech />
        <div className="flex flex-col gap-1.5 h-[150px] w-[150px] items-center justify-center mr-[150px]">
          <div className="flex h-[100px] w-[100px] justify-center items-center font-bold">
